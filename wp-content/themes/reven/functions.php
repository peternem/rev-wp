...
function twentytwelve_scripts_styles() {
	...
	wp_enqueue_style( 'twentytwelve-main', get_template_directory_uri() . '/css/main.css', array( 'twentytwelve-style' ), '20121010' );

	// Loads the Internet Explorer specific stylesheet.
	wp_enqueue_style( 'twentytwelve-ie', get_template_directory_uri() . '/css/ie.css', array( 'twentytwelve-style' ), '20121010' );
	$wp_styles->add_data( 'twentytwelve-ie', 'conditional', 'lt IE 9' );
	
	wp_enqueue_script( 'twentytwelve-slideshow', get_template_directory_uri() . '/js/jquery.cycle2.js', array( 'jquery' ), '20140711', true );
	wp_enqueue_script( 'twentytwelve-scripts', get_template_directory_uri() . '/js/sitewide-scripts.js', array( 'jquery' ), '20140711', true );
}
