...
<html lang="en">
	<head>
		<title>Fury - High Performance Road Race Bike - REVEN Bicycles</title>
		...
		<div id="container">
			...
			<div id="heroImage">
				...
				<div id='slideshow' class="cycle-slideshow" data-cycle-fx="scrollHorz" data-cycle-pause-on-hover="true"  data-cycle-speed="1000"  data-cycle-timeout="6000" data-cycle-prev="#prev" data-cycle-next="#next">
					<img src="images/road/fury/fury_frame_940x425.jpg" alt="Reven Fury" class="mainImage"/>
					<img src="images/road/fury/IMG_4194_940x425.jpg" alt="Reven rides snowy Belgium" class="mainImage"/>
					<img src="images/road/fury/IMAGE_4238_TWEAKED_940x425.jpg" alt="Reven rides the Belgium Country side"class="mainImage"/>
				</div>
			...
			<div id="mainContent">
				<div class="imageCenter clearfix">
					...
					<a href="#" class="ajaxImg"><img src="images/road/frame-a/frame_a_detail_rear_brake_485x356.jpg" title="Reven Fury - Seat tube and Rear Brake Detail" alt="Reven Fury Seat Tube" class="imageStyleLeft hvr" /></a>
					<img src="images/lifestyle/IMG_4234_TWEAKED_155x130.jpg"  alt="Ride Reven Bikes" class="imageStyleUpperRh"/>
					<a href="#" class="ajaxImg"><img src="images/road/frame-a/frame_a_detail_downtube_465x390.jpg" title="Reven Fury - Downtube Detail" alt="Reven Fury Downtube" class="imageStyleLowerRh hvr"/></a>
				...
				<h2>FURY</h2>
				<p class="bikeModel">Our flagship road racing machine. The Fury is built from the ground up to be second to none. Starting with
					the front end, where an oversized head tube allows a tapered fork steerer, resulting in front-end stiffness and improved
					handling.  A large-diameter down tube widens near a massive bottom bracket that makes sure all your power goes straight
					to the rear wheel.  Internal cable routing keeps things clean, and the frame is available in Shimano BB or PF30, and
					standard cable or Di2 cable routing.</p>
