...
<html lang="en">
	<head>
		<title>Hammer - 27.5"/650B Race Mountain Bike - REVEN Bicycles</title>
		...
		<div id="container">
			...
			<div id="heroImage">
				...
				<div id='slideshow' class="cycle-slideshow" data-cycle-fx="scrollHorz" data-cycle-pause-on-hover="true"  data-cycle-speed="1000"  data-cycle-timeout="6000" data-cycle-prev="#prev" data-cycle-next="#next">
					<img src="images/mtb/hammer/HERO_IMG_4172_940x425.jpg" alt="Reven Hammer 260b MTB" class="mainImage"/>
					<img src="images/slideshow-bikes/DSCN0832_941x427_v1.jpg" alt="Reven Rides Dalles Ridge" class="mainImage"/>
				</div>
			...
			<div id="mainContent">
				<div class="imageCenter clearfix">
					<img src="images/lifestyle/DSCN1003_485x386.jpg" alt="Reven Rides Bends Big Fat Tour" class="imageStyleLeft"/>
					<a href="#" class="ajaxImg"><img src="images/mtb/hammer/IMG_4289_485x386.jpg" title="Reven Hammer - Seat Tube and Downtube Detail" alt="The Reven Hammer" class="imageStyleLeft hvr" /></a>
					<img src="images/lifestyle/DSC06619_155x130.jpg"  alt="Ride Reven Bikes" class="imageStyleUpperRh"/>
					<a href="#" class="ajaxImg"><img src="images/mtb/hammer/IMG_4290_465x390.jpg" title="Reven Hammer - Head Tube Detail" alt="Hammer Head Tube" class="imageStyleLowerRh hvr"/></a>
				...
				<h2>HAMMER</h2>
				<p class="bikeModel">Why bring a knife to a gunfight?  Instead bring a bazooka.  Or a Hammer.  With 27.5” wheels, tapered head tube, 
					extremely stiff bottom bracket, this thing is designed for sprinting up and down hills. 27.5”, or 650B, is the new black.
					The wheels roll faster than 26” and yet are more agile than 29”. This wheel size is already world championship proven.
					So join the revolution.  Or as we like to say, the REVEN-lution.</p>
					...
					<table id="geoList">
						<tbody>
							...
							foreach ($xml->model as $model) {
								if ($model -> attributes() -> name == 'HAMMER') {
