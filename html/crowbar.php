...
<html lang="en">
	<head>
		<title>Crowbar - Cyclocross Bike - REVEN Bicycles</title>
		...
		<div id="container">
			...
			<div id="heroImage">
				...
				<div id='slideshow' class="cycle-slideshow" data-cycle-fx="scrollHorz" data-cycle-pause-on-hover="true"  data-cycle-speed="1000"  data-cycle-timeout="6000" data-cycle-prev="#prev" data-cycle-next="#next">
					<img src="images/cross/crowbar/crowbar_illustration_940x425.jpg" alt="Reven Crowbar Cyclocross Bike" class="mainImage"/>
			...
			<div id="mainContent">
				...
				<h2>CROWBAR</h2>
				<p class="bikeModel">Cross racing - We fully advocate pushing your competition into the barriers.  This is war, after all.
					And in order to win, you need a quick, light, stiff, and snappy machine to throw around the course.  Which brings us
					to the Crowbar.   It’s a monocoque frame of high-modulus carbon fiber, tuned to be slightly more stiff than responsive.
					After all, your race is only for an hour.</p>
				<p class="bikeModel">Race-ready geometry.  Race-ready performance.  Race-ready paint.  Crowbar.</p>
